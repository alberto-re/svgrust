...
fn main() -> Result<()> {
    ...
    let vector_field = PerlinNoise2dVectorField::new(0.009, 0.009, seed.into());
    ...
    bbox.sample_uniform(&mut rng, 4000)
        ...
        .for_each(|center| {
            ...
            for _ in 0..1000 {
                let angle = vector_field.angle_at(pos, PI / 4.);
    ...
    sketch.add_group(&trails, &Style::new("white", "1.0px"));
